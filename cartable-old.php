     ...
     <div class="box-incoming">
         ...
         <table class="customer-list">
             <tr>
                 <th>شماره</th>
                 <th>مشخصات</th>
                 <th class="extra-info-header">موبایل نیایش</th>
                 <th class="extra-info-header">حسابداری محک</th>
                 <th>داخلی</th>
...
$repeat = $row["time"];    */
                ...
                ?>
                             ...
                             <tr>
                                 ...
                                 <td> <?php taglabelshow($taglabel)  ?></td>
                                 <td> <?php userlabelshow($userlabel)  ?></td>
     ...
     <div class="box-doing">
         <h2 class="title">نیاز به پیگیری</h2>
         ...
         <table class="customer-list">
             ...
             <?php
                ...
                $sql = "SELECT * FROM customer WHERE cartable=1   ";
                $result = mysqli_query($con, $sql);
                if (mysqli_num_rows($result) > 0) {
     ...
     <div class="box-done">
         <h2 class="title">نیاز به قفلی</h2>
         ...
         <table class="customer-list">
             ...
             <?php
                ...
                $sql = "SELECT * FROM customer WHERE cartable=2   ";
                $result = mysqli_query($con, $sql);
                if (mysqli_num_rows($result) > 0) {
     ...
     <div class="box-ohoh">
         ...
         <table class="customer-list">
             ...
             <?php
                ...
                $sql = "SELECT * FROM customer WHERE cartable=3   ";
                $result = mysqli_query($con, $sql);
                if (mysqli_num_rows($result) > 0) {
