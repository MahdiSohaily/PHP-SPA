...
<body>
    <div>
        <div class="min-h-screen ">
            ...
            <!-- Page Content -->
            <main class="pt-12">
                <div class="flex justify-between bg-gray-200 fixed w-full shadow-lg" style="top: 0; z-index:100">
                    ...
                    <ul class="flex mr-20 py-3">
                        ...
                        <li>
                            <a target="_blank" class="px-4 py-2 bg-violet-600 ml-2 rounded-md text-white text-xs" href="./report/givePrice.php">
                                <i class="fas fa-feather-alt"></i>
                                قیمت دهی دستوری
                            </a>
                        </li>
