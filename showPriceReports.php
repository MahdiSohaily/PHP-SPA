                                                    ...
                                                    <?php foreach ($givenPrice as $price) { ?>
                                                        <?php if ($price['price'] !== null) {
                                                            if (array_key_exists("ordered", $price) || $price['customerID'] == 1) { ?>
                                                                ...
                                                                <?php  } ?>
                                                                <td scope="col" class="text-gray-800 px-2 py-1 <?php echo array_key_exists("ordered", $price) || $price['customerID'] ? 'text-white' : '' ?>">
                                                                    <?php echo $price['price'] === null ? 'ندارد' : $price['price']  ?>
                                                                </td>
                                                                <td scope="col" class="text-gray-800 px-2 py-1 rtl <?php echo array_key_exists("ordered", $price) || $price['customerID'] && 'text-white' ? 'text-white' : '' ?>">
